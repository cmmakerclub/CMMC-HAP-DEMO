...
var LightController = {
  name: 'Demo Light', //name of accessory
  pincode: '031-45-154',
...
lightAccessory.addService(Service.Lightbulb, LightController.name) // services exposed to the user should have "names" like "Light" for this case
...
lightAccessory.getService(Service.Lightbulb).
